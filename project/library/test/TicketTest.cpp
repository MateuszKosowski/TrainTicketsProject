/**
 * @file TicketTest.cpp
 * @brief Plik testów jednostkowych dla klasy Ticket.
 * 
 * Testuje funkcjonalności związane z konstruktorem klasy Ticket, weryfikując poprawność tworzenia obiektów i ich właściwości.
 */
...
BOOST_AUTO_TEST_SUITE(TicketTestSuite)
    ...
    /**
     * @brief Test konstruktora Ticket.
     * 
     * Sprawdza, czy obiekt Ticket jest prawidłowo tworzony z przekazanymi parametrami oraz czy właściwości biletu są poprawne.
     */
    BOOST_AUTO_TEST_CASE(ConstructorTest)
    {
        AddressPtr testAddress = std::make_shared<Address>("Zgierz", "Parzeczewska", "1");
        ...
        BOOST_CHECK_EQUAL(ticket->getTravelTime(), 50);
    }
